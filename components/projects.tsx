...
export function Projects() {
  ...
  const previewX = useSpring(mouseX, { stiffness: 150, damping: 20, mass: 0.4 })
  const previewY = useSpring(mouseY, { stiffness: 150, damping: 20, mass: 0.4 })
  ...
  return (
    <section id="work" className="relative px-6 py-24 md:px-14 md:py-36 lg:px-20">
      <div className="mx-auto max-w-7xl">
        <SectionHeading number="01" title="Selected Work" />

        <div className="relative mt-4" ref={listRef} onMouseMove={handleMouseMove}>
